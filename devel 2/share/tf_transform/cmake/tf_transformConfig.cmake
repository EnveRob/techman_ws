...
if("TRUE" STREQUAL "TRUE")
  set(tf_transform_SOURCE_PREFIX /home/a891021960035/Desktop/Parallels Shared Folders/psf/EnveRob/techman_ws/src/tf_transform)
  set(tf_transform_DEVEL_PREFIX /home/a891021960035/Desktop/Parallels Shared Folders/psf/EnveRob/techman_ws/devel)
  ...
  set(tf_transform_INSTALL_PREFIX /home/a891021960035/Desktop/Parallels Shared Folders/psf/EnveRob/techman_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf_transform' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/a891021960035/Desktop/Parallels Shared Folders/psf/EnveRob/techman_ws/src/tf_transform/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(tf_transform_EXPORTED_TARGETS ${${tf_transform_dep}_EXPORTED_TARGETS})
endforeach()
