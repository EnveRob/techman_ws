...
if("TRUE" STREQUAL "TRUE")
  set(tm_driver_SOURCE_PREFIX /home/a891021960035/Desktop/Parallels Shared Folders/psf/EnveRob/techman_ws/src/tm_driver)
  set(tm_driver_DEVEL_PREFIX /home/a891021960035/Desktop/Parallels Shared Folders/psf/EnveRob/techman_ws/devel)
  ...
  set(tm_driver_INSTALL_PREFIX /home/a891021960035/Desktop/Parallels Shared Folders/psf/EnveRob/techman_ws/install)
...
if(NOT "/home/a891021960035/Desktop/Parallels Shared Folders/psf/EnveRob/techman_ws/src/tm_driver/include " STREQUAL " ")
  set(tm_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/a891021960035/Desktop/Parallels Shared Folders/psf/EnveRob/techman_ws/src/tm_driver/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tm_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/a891021960035/Desktop/Parallels Shared Folders/psf/EnveRob/techman_ws/src/tm_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT tm_driver_NUM_DUMMY_TARGETS)
      set(tm_driver_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::tm_driver::wrapped-linker-option${tm_driver_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR tm_driver_NUM_DUMMY_TARGETS "${tm_driver_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::tm_driver::wrapped-linker-option${tm_driver_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND tm_driver_LIBRARIES "${interface_target_name}")
...
set(depends "actionlib;control_msgs;geometry_msgs;roscpp;sensor_msgs")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(tm_driver_EXPORTED_TARGETS ${${tm_driver_dep}_EXPORTED_TARGETS})
endforeach()
